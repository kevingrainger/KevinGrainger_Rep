...
plt.style.use('seaborn-v0_8') #needed for thenice shading
...
class Portfolio_manager:
    ...
    def detect_regimes(self):
        self.hmm = hmm_regime_det().fit(self.oil_returns)
        self.garch = GARCH_vol().fit(self.oil_returns)
        return self

    def optimize_portfolio(self, lookback=252): #lessen to speed things up
